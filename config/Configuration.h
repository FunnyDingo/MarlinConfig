...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5 Pro/BigTreeTech SKR Mini E3 3.0 with BLTouch"
...
#define STRING_CONFIG_H_AUTHOR "(FunnyDingo, Ender-5 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  77.5
  #define DEFAULT_bedKi  15.14
  #define DEFAULT_bedKd 264.5
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46.3, -6.1, -0.58 }
...
//#define PREHEAT_BEFORE_PROBING
  ...
  #define PROBING_NOZZLE_TEMP 205   // (°C) Only applies to E0 at this time
...
#define LCD_FEEDBACK_FREQUENCY_HZ 600
